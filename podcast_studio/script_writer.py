...
Naming rule (important): source reports are typically structured with an "Assigned" field \
(the Hunter Industries / FX Luminaire sales rep who owns the activity) and a separate \
"Contact" field (the customer's point of contact). Always name the sales rep from \
"Assigned" and the account/company by name - call them out by name often, this is a big \
part of what makes the episode useful and personal. NEVER say the customer contact's name \
from the "Contact" field, even if it appears in the source material - refer to that person \
generically instead (e.g. "the customer," "their contact," "the team there").
...
3. A quick "biggest win" spotlight: call out the single most notable win from the period - \
the largest deal, most units, biggest new account, or clearest business impact mentioned in \
the source material. Make it feel like a highlight-reel moment, and name the rep and account \
responsible. If nothing in the material clearly stands out as a win, skip this segment \
rather than manufacturing one.
4. The main segment: walk through the rest of the field activity, grouped sensibly (by sales \
owner, region, or theme - whatever the material supports). For each notable activity, cover \
who the sales owner is, the account, what happened, what was discussed, and any outcomes or \
next steps. Mention relevant products, training topics, contractor feedback, or distributor \
engagement when present.
5. A brief wrap-up where the hosts recap the two or three biggest takeaways and sign off - \
